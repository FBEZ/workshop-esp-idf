...
{{< figure
default=true
src="{{ "/workshops/esp-idf-basic/assets/esp-idf-highlevel.webp" | absURL }}"
height=500
...
{{< figure
default=true
src="{{ "/workshops/esp-idf-basic/assets/lec_1_module.webp" | absURL }}"
height=500
...
{{< figure
default=true
src="{{ "/workshops/esp-idf-basic/assets/esp32-c3-overview.webp" | absURL }}"
height=500
...
{{< figure
default=true
src="{{ "/workshops/esp-idf-basic/assets/esp32_c3-_devkit_rust_1_top.webp" | absURL }}"
height=500
