...
series_order: 1
showAuthor: false
summary: "In this lesson, we introduce ESP-IDF, the official Espressif framework for IoT application development, exploring its architecture, main components, and development tools. We also examine the hardware used in the workshop, based on the ESP32-C3 SoC, thus preparing the ground for the first practical exercise."
---
...
You can find the schematic of the version 1 of the evk on the [github page](https://github.com/esp-rs/esp-rust-board/blob/master/hardware/esp-rust-board/schematic/esp-rust-board.pdf).
