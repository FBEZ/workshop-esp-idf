...
{{< figure
default=true
src="{{ "/workshop-esp-idf/workshops/esp-idf-basic/assets/lec_3_led_gpio.webp" | absURL }}"
...
{{< figure
default=true
src="{{ "/workshop-esp-idf/workshops/esp-idf-basic/assets//lec_3_registry.webp" | absURL }}"
