...
series_order: 8
showAuthor: false
summary: "In this lecture we'll explore how to include libraries which are part of the ESP-IDF, external libraries and components from the ESP component registry"
---
...
* Choose the core (ESP32-C3) in the upper left corner
