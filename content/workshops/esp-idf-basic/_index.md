...
date: "2025-11-12"
summary: "This workshop focuses on the basics of the ESP-IDF framework: you will compile your first project and program the ESP32-C3 module mounted on an EVK. During this activity, you will create ESP-IDF components and start an HTTP server with REST APIs."
---
...
In this workshop, you will gain a solid understanding of the ESP-IDF framework, learning how to effectively use Visual Studio Code (VS Code) and Espressif’s official VS Code extension.
...
The workshop is divided into three parts, each lasting about one hour.
...
* **ESP-IDF** installed on your machine
  *Can be installed via VS Code or by using the [ESP-IDF Installer Manager](https://docs.espressif.com/projects/idf-im-cli/en/latest/index.html)*
...
If the event is held in person, it’s strongly recommended to install **VS Code** and the **ESP-IDF plugin** **before** the start of the workshop.
