...
series_order: 3
showAuthor: false
summary: "Create a new project from example `blink` and change the output GPIO pin via `menuconfig`"
---

## Assignment outcomes

1. Creation of a new project from example `blink`
2. Change the output GPIO according to the board schematic. 
3. Blinking of EVK Led
